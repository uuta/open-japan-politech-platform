...
const REAL_BILLS: RealBill[] = [
  ...
  },
  {
    ...
    title: "民法の一部を改正する法律案",
    summary:
      "女性の再婚禁止期間の短縮。最高裁判決（平成27年12月）を踏まえ、6か月から100日に短縮。",
    proposer: "内閣",
    category: "司法",
    status: "ENACTED",
    submittedAt: "2016-03-11",
  ...
  },
  {
    ...
    summary:
      "パリ協定を踏まえた地球温暖化対策計画の策定義務化。地方公共団体実行計画の拡充等。",
    proposer: "内閣",
    category: "環境",
    status: "ENACTED",
  ...
  },
  {
    sessionNumber: 190,
    number: "190-閣法-25",
    title: "障害者の日常生活及び社会生活を総合的に支援するための法律及び児童福祉法の一部を改正する法律案",
    summary:
  ...
  },
  {
    sessionNumber: 193,
    number: "193-閣法-41",
    title: "個人情報の保護に関する法律及び行政手続における特定の個人を識別するための番号の利用等に関する法律の一部を改正する法律案",
    summary:
